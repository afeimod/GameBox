...
# Use CMAKE_CURRENT_*_DIR (not CMAKE_SOURCE_DIR/BINARY_DIR): this file is included from the
# android cpp/CMakeLists.txt, which GameBox integrates as a subproject, so the top-level
# source/build dirs resolve to GameBox's own paths. add_subdirectory() above also resolves
# 3rdparty/libjpeg-turbo relative to this directory, so the include dirs must match it.
target_include_directories(jpeg-static PUBLIC
	$<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/3rdparty/libjpeg-turbo/src>
	$<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}/3rdparty/libjpeg-turbo>
)
