// WAFlash Engine - Standalone build
// WebAssembly AS2/AS3 Flash compatible player
// Original by vidkidz (https://github.com/vidkidz/waflash)
// Extracted from https://vidkidz.github.io/
(function() {
  // === setImmediate polyfill (replaces webpack URgk module) ===
  var setImmediate = (function() {
    if (typeof window !== 'undefined' && window.setImmediate) return window.setImmediate;
    if (typeof window !== 'undefined' && window.postMessage) {
      var timeouts = [];
      var messageName = 'setImmediate$waflash';
  ...
  var clearImmediate = function(id) { /* simplified */ };

  var __module = { exports: {} };
  var __exports = __module.exports;
  var __require = function(name) {
    if (name === 'URgk') return { setImmediate: setImmediate, clearImmediate: clearImmediate };
    return {};
  };

  // === JmBL Module Body (Emscripten WAFlash engine) ===
  var e, r = __exports, t = __require;
  ...
  if (typeof __exports.a !== 'undefined') {
    window.WAFlashFactory = __exports.a;
  }
})();
